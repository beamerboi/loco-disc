...
module.exports.run = async(bot , message , args) =>{
    ...
    if(!message.member.hasPermission("BAN_MEMBERS")) return message.channel.send(`i'm not gonna let you do that...do you think i was born yesterday...joke's on you pal i was born in ${bot.user.createdAt.toDateString()}`);
